...
public class J2CacheUtils {
     ...
     * @param value
     * @param liveSeconds
     * @param cacheNullObject
     */
    public static void set(String key, Object value,long liveSeconds,boolean cacheNullObject) {
        put(SYS_CACHE_NAME,key,value,liveSeconds,cacheNullObject);
    }
     ...
     * @param key
     * @param value
     * @param liveSeconds 单位：秒
     * @param cacheNullObject
     */
    public static void put(String cacheName, String key, Object value,long liveSeconds,boolean cacheNullObject){
        cache.set(cacheName, key, value,liveSeconds, cacheNullObject);
    }
