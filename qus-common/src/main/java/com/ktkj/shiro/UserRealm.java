package com.ktkj.shiro;

import com.ktkj.cache.J2CacheUtils;
import com.ktkj.dao.SysMenuDao;
import com.ktkj.dao.SysUserDao;
import com.ktkj.entity.SysMenuEntity;
...
public class UserRealm extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        //系统管理员，拥有最高权限
        if (userId == Constant.SUPER_ADMIN||"Z".equals(user.getCityId())) {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(
        ...
        //系统管理员，拥有最高权限
        if (Constant.SUPER_ADMIN == user.getUserId()||"Z".equals(user.getCityId())) {
