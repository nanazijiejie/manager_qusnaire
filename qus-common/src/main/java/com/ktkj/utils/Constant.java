...
public class Constant {
     ...
     * 数据字典缓存时间
     */
    public static long ALIVE_SECONDS = 60*60l;//所有的配置一律缓存一小时
    /**
     * 云存储配置KEY
     */
     ...
     * 地市领导班子
     */
    public static final String CITY_STATION = "15";
    /**
     * 分管副职
     */
    public static final String DEPT_STATION = "14";
    /**
     * 地市副职
     */
    public static final String CITY_DEPT_STATION = "11";
    /**
     * 地市正职
     */
    public static final String CITY_RIGHT_STATION = "10";
