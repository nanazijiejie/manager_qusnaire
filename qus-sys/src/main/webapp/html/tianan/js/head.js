$(function () {
  ...
  $('.music').on('click',function(){
    ...
    $('.wenanLink').click(function () {
        $('.wenan').hide();
        $('.photoImgs').show();
    })
    $('.alert-c,.alert-bg').click(function () {
        $('.alert').hide();
    })
    ...
    function drawAndShareImage(base64Data){
        ...
        myImage.onload = function(){
            ...
            /*if(base64Data.indexOf("jpeg")!=-1||base64Data.indexOf("jpg")!=-1){
                myImage2.src = "images/tianan.jpeg";   //你自己本地的图片或者在线图片
            }else{
                   //你自己本地的图片或者在线图片
            }*/
            myImage2.src = "images/tianan.jpeg";
            myImage2.onload = function(){
                context.drawImage(myImage2 , 0 , 0 , 700 , 700);
                var base64 = "";
                base64 = canvas.toDataURL("image/jpeg");
                /*if(myImage2.src.indexOf('png')!=-1){
                      //"image/png" 这里注意一下
                }else{
                    base64 = canvas.toDataURL("image/jpeg");
                }*/
