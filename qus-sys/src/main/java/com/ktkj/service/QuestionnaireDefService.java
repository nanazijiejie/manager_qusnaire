/*
 * 类名称:QuestionnaireDefService.java
 ...
 */
public interface QuestionnaireDefService extends IService<QuestionnaireDefEntity> {
     ...
     * @return List
     */
    List<QuestionnaireDefEntity> queryAll(Map<String, Object> params);
     ...
     * @return 新增结果
     */
    boolean add(QuestionnaireDefEntity questionnaireDef);
     ...
     * @return 更新结果
     */
    boolean update(QuestionnaireDefEntity questionnaireDef);
