...
public class JsSignUtil {
    ...
    public static String tokenKey = "WEIXINTOKENKEY";
    public static long aliveSeconds = 60*60l;

    public static Map<String, String> sign(String url){
        if( J2CacheUtils.get(tokenKey)!=null){
            accessToken = (String)J2CacheUtils.get(tokenKey);
            System.out.println("accessToken1:"+accessToken);
        }else{
            accessToken = TokenUtil.getToken().getAccessToken();
            J2CacheUtils.set(tokenKey,accessToken,aliveSeconds,false);
...
// System.out.println("string1="+string1);
        ...
        ret.put("appId", "wx5b56683402673307");
...
// System.out.println("6.timestamp="+ret.get("timestamp"));
    ...
    public static  void  main(String[]args){
       // J2CacheUtils.set(tokenKey,"hsagducgbeyguegd",aliveSeconds,false);
        System.out.println(J2CacheUtils.get(tokenKey));
    }
}
